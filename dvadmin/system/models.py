...
class Users(CoreModel, AbstractUser):
    ...
    identity_card = models.CharField(max_length=18, verbose_name="身份证", help_text="身份证", default='')
    GENDER_CHOICES = (
        (0, "未知"),
        (1, "男"),
        (2, "女"),
...
class FileList(CoreModel):
    ...
    upload_method = models.SmallIntegerField(default=0, blank=True, null=True, choices=UPLOAD_METHOD_CHOIDES,
                                             verbose_name='上传方式', help_text='上传方式')
    FILE_TYPE_CHOIDES = (
        (0, '图片'),
        (1, '视频'),
        (2, '音频'),
    ...
    file_type = models.SmallIntegerField(default=3, choices=FILE_TYPE_CHOIDES, blank=True, null=True,
                                         verbose_name='文件类型', help_text='文件类型')
